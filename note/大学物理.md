...
**例如：**
- 左图：$\oint \vec{B} \cdot \mathrm{d}\vec{l} = \mu_0 (I_1 - I_2)$
- 中图：$\oint \vec{B} \cdot \mathrm{d}\vec{l} = \mu_0 (I_1 + I_3)$
- 右图：$\oint \vec{B} \cdot \mathrm{d}\vec{l} = -4\mu_0 I$
